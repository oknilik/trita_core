export default function ProfileLoading() {
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-5xl flex-col gap-6 bg-[#faf9f6] px-4 py-10">
      <div className="animate-pulse rounded-2xl bg-gradient-to-br from-[#c8410a] to-[#8b2f09] p-6 pb-14 md:p-8 md:pb-16">
      ...
      <div className="animate-pulse rounded-2xl border border-[#e8e4dc] bg-white p-6">
        <div className="h-5 w-48 rounded bg-[#e8e4dc]" />
        <div className="mt-4 h-4 w-72 rounded bg-[#f3eee4]" />
        <div className="mt-6 flex flex-col gap-4">
          <div className="h-11 rounded-lg bg-[#f3eee4]" />
          <div className="h-11 rounded-lg bg-[#f3eee4]" />
          <div className="h-20 rounded-lg bg-[#f3eee4]" />
          <div className="h-20 rounded-lg bg-[#f3eee4]" />
          <div className="h-11 rounded-lg bg-[#f3eee4]" />
        </div>
      </div>
      <div className="animate-pulse rounded-2xl border border-[#e8e4dc] bg-white p-6">
        <div className="h-5 w-32 rounded bg-[#e8e4dc]" />
        <div className="mt-4 flex gap-2">
          <div className="h-11 w-24 rounded-lg bg-[#f3eee4]" />
          <div className="h-11 w-24 rounded-lg bg-[#f3eee4]" />
          <div className="h-11 w-24 rounded-lg bg-[#f3eee4]" />
        </div>
      </div>
