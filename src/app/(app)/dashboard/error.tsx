...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-cream px-4 py-10">
      <div className="w-full max-w-xl rounded-[24px] border border-sand bg-surface-card px-6 py-8 text-center shadow-[0_16px_40px_rgba(26,26,46,0.04)] md:px-8">
        ...
        <button
          onClick={reset}
          className="mt-6 inline-flex min-h-[44px] items-center rounded-[10px] bg-[var(--color-accent-primary)] px-6 text-[12px] font-semibold text-[var(--color-text-on-accent)] transition hover:brightness-110"
        >
          Újrapróbálás
        </button>
      </div>
