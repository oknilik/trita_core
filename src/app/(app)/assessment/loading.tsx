  ...
  return (
    <div className="min-h-dvh bg-cream">
      <div className="mx-auto max-w-3xl px-4 py-8 md:py-12">
        ...
        <div className="mb-8 animate-pulse rounded-2xl border border-sand bg-surface-card p-4">
          <div className="h-36 w-full rounded-lg bg-warm" />
        </div>
        <div className="animate-pulse rounded-2xl border border-sand bg-surface-card p-6">
