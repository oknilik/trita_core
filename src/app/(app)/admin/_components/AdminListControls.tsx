    ...
    <div className="mb-4 flex flex-wrap items-center gap-3">
      <div className="relative min-w-[200px] flex-1">
        <input
          ...
          className="min-h-[40px] w-full rounded-lg border border-sand bg-surface-card px-3 text-xs text-ink outline-none transition focus:border-sage"
        />
      </div>
      ...
      {matched > limit && (
        <button
          ...
          className="min-h-[40px] rounded-lg border border-sand bg-surface-card px-3 text-xs font-semibold text-ink-body transition hover:text-ink"
        >
