...
import { ladderBaseFee } from "@/lib/pricing/team-ladder";
      ...
      <JsonLd
        data={[
          ...
          buildServiceJsonLd({
            ...
            description:
              "Tanácsadó-vezérelt csapatprogram személyiség-alapú csapatképpel, mért csapatszerep-térképpel és pszichológiai biztonság pulzusméréssel – minimum projektárral, minden méréssel.",
