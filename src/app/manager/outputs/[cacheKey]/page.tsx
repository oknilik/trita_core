...
import { ShareDebriefButton } from "@/components/manager/ShareDebriefButton";
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-10">
            ...
            <section className="relative overflow-hidden rounded-2xl border border-indigo-200/60 bg-gradient-to-br from-indigo-100/80 via-purple-50/60 to-pink-50/40 p-7 shadow-md shadow-indigo-200/40">
              ...
              <div className="relative z-10">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-600">
                  {isHu ? "Coaching anyag" : "Coaching debrief"}
                </p>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-gray-400">
                  <span>{output.createdAt.toLocaleDateString(dateLocale)}</span>
                  <span>·</span>
        ...
        <FadeIn delay={0.15}>
          <div className="flex gap-3 pt-2">
            <Link
              href="/manager"
              className="min-h-[44px] inline-flex items-center gap-1.5 rounded-lg border border-gray-100 bg-white px-5 text-sm font-semibold text-gray-700 transition hover:bg-gray-50"
            >
              <svg viewBox="0 0 16 16" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M10 3L5 8l5 5" />
              </svg>
            ...
            <ShareDebriefButton cacheKey={output.cacheKey} existingToken={output.shareToken} isHu={isHu} />
          </div>
        </FadeIn>
