    ...
    <div className="flex min-h-dvh items-center justify-center bg-cream px-4 py-12">
      <div className="w-full max-w-lg">
        <div className="mb-10 flex animate-pulse flex-col items-center gap-4">
          <div className="h-10 w-10 rounded-full bg-bronze-soft" />
          <div className="h-8 w-52 rounded bg-sand" />
          <div className="h-4 w-40 rounded bg-warm" />
        </div>
        <div className="mb-8 animate-pulse">
          <div className="mb-2 flex justify-between">
            <div className="flex items-center gap-1.5">
              <div className="h-6 w-6 rounded-full bg-sand" />
              <div className="hidden h-3 w-10 rounded bg-warm sm:block" />
            </div>
            <div className="flex items-center gap-1.5">
              <div className="h-6 w-6 rounded-full bg-sand" />
              <div className="hidden h-3 w-10 rounded bg-warm sm:block" />
        ...
        <div className="animate-pulse rounded-2xl border border-sand bg-white p-6 md:p-8">
          ...
          <div className="mt-8 h-12 rounded-lg bg-bronze-soft" />
        </div>
      </div>
    </div>
  );
