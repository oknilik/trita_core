...
export function ShareRow({
  ...
  const btn =
    "inline-flex h-8 min-w-8 items-center justify-center gap-1.5 rounded-lg border border-sand bg-white px-2 text-caption text-[var(--color-text-secondary)] transition-colors hover:border-[var(--color-surface-self-border)] hover:text-[var(--color-accent-self-deep)]";
