          ...
          {features.map((f, i) => (
            <Reveal
              ...
              className={[
                ...
                "flex flex-col rounded-[24px] border border-[var(--color-border-default)] p-7 shadow-sm transition-[translate,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(26,26,46,0.06)]",
