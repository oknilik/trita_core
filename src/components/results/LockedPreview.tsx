  ...
  return (
    <div className="mt-[18px] flex flex-col gap-2">
      {!isPlus && (
        <div className="flex cursor-pointer items-center gap-3 rounded-xl border-[1.5px] border-[#ddd5c8] bg-[#f2ede6] px-5 py-3.5 transition-colors hover:bg-[#e8e0d3]">
          ...
          <span className="flex-1 text-xs leading-relaxed text-[#8a8a9a]">
            {isHu
              ? "Mi áll a dimenziók mögött? · Milyen szerepkörök illenek hozzád? · Hol fejlődhetsz a leggyorsabban?"
              : "What's behind your dimensions? · Which roles fit you? · Where can you grow fastest?"}
          </span>
      ...
      <div className="flex cursor-pointer items-center gap-3 rounded-xl border-[1.5px] border-[#ddd5c8] bg-[#f2ede6] px-5 py-3.5 transition-colors hover:bg-[#e8e0d3]">
        ...
        <span className="flex-1 text-xs leading-relaxed text-[#8a8a9a]">
          {isHu
            ? "Hogyan látnak mások? · Mik a vakfoltjaid? · Observer visszajelzés elemzés"
            : "How do others see you? · What are your blind spots? · Observer feedback analysis"}
        </span>
