  ...
  const observerPart =
    flow.state === "available" ? (
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-full bg-state-warning-bg px-3 py-1.5 text-xs font-semibold text-amber-800 ring-1 ring-state-warning-border transition hover:bg-amber-100"
      >
