...
export function BackChevronIcon({
  ...
  return (
    <span
      aria-hidden="true"
      className={cn(
        "inline-flex shrink-0 items-center justify-center bg-[var(--color-surface-subtle)] text-[var(--color-text-muted)] transition-colors group-hover:bg-[var(--color-border-default)] group-hover:text-[var(--color-text-primary)]",
        sizeClasses[size],
        className,
      )}
    >
