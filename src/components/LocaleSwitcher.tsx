  ...
  return (
    <>
      <button
        ...
        className={
          variant === "icon"
            ? `flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg border border-gray-100 bg-white text-gray-700 transition hover:border-gray-200 ${className ?? ""}`
            : `relative flex min-h-[44px] items-center rounded-lg border border-gray-100 bg-white pl-9 pr-7 text-xs font-semibold text-gray-700 transition hover:border-gray-200 ${className ?? ""}`
        }
      >
        {variant === "icon" ? (
