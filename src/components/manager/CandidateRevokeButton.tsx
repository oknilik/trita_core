  ...
  return (
    <>
      <button
        ...
        className="min-h-[36px] inline-flex items-center rounded-lg border border-sand bg-white px-3 text-[11px] font-semibold text-ink-body transition hover:border-accent-candidate-border hover:text-accent-candidate"
      >
      ...
      >
        <div className="flex flex-col-reverse items-center gap-2 sm:flex-row sm:items-center sm:justify-center sm:gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="min-h-[44px] rounded-[10px] bg-accent-candidate px-5 text-sm font-semibold text-white transition hover:bg-accent-candidate-strong disabled:cursor-not-allowed disabled:opacity-50"
          >
            {loading
