  ...
  dimensions: [
    {
      ...
      color: "#818CF8",
      description: "Az integritás dimenzió azt tükrözi, mennyire tartózkodik valaki mások manipulálásától, a szabályszegéstől, az anyagi javak hajhászásától és a kiemelt társadalmi státusz hajszolásától. Négy alskálára bontható: Egyenesség (valódi, nem manipulatív viszonyulás másokhoz), Méltányosság (a csalás és korrupció kerülése), Mértékletesség (az anyagi javak és státusz iránti közömbösség), Szerénység (nem tekinti magát privilegizáltnak vagy különlegesnek).",
      descriptionByLocale: {
        en: "The Integrity dimension reflects the extent to which a person avoids manipulating others for personal gain, feels little temptation to break rules, is uninterested in lavish wealth and luxury, and feels no special sense of entitlement. Its four facets are Sincerity (genuine, non-manipulative engagement with others), Fairness (avoidance of fraud and exploitation), Moderation (indifference to material wealth and social status), and Modesty (not viewing oneself as superior or deserving of special treatment).",
      ...
      facets: [
        { code: "sincerity", label: "Sincerity", labelByLocale: { en: "Sincerity", hu: "Egyenesség" } },
        { code: "fairness", label: "Fairness", labelByLocale: { en: "Fairness", hu: "Méltányosság" } },
        { code: "greed_avoidance", label: "Moderation", labelByLocale: { en: "Moderation", hu: "Mértékletesség" } },
    ...
    },
    {
      ...
      color: "#FB7185",
      description: "A rezonancia dimenzió azt méri, mennyire érzékeny valaki a fizikai veszélyekre és a stresszes helyzetekre, mennyire igényli mások érzelmi támogatását, és mennyire erős az érzelmi kötődése és empátiája. Négy facetje az Óvatosság (a fizikai sérülés elkerülésére való hajlam), a Stresszérzékenység (aggódásra való hajlam különféle nehézségekkel szemben), a Támaszkeresés (mások érzelmi támogatásának igénye) és az Érzelmi kötődés (erős érzelmi kötődés és empatikus érzékenység mások iránt).",
      descriptionByLocale: {
        en: "The Resonance dimension measures sensitivity to physical danger and life stresses, the need for emotional support from others, and the strength of emotional bonds and empathic sensitivity. Its four facets are Caution (tendency to avoid physical harm), Stress Sensitivity (tendency to worry in response to difficulties), Support Seeking (need for emotional support from others), and Emotional Bonding (strong emotional attachments and empathic sensitivity to others' feelings).",
        hu: "A rezonancia dimenzió azt méri, mennyire érzékeny valaki a fizikai veszélyekre és a stresszes helyzetekre, mennyire igényli mások érzelmi támogatását, és mennyire erős az érzelmi kötődése és empátiája. Négy facetje az Óvatosság (a fizikai sérülés elkerülésére való hajlam), a Stresszérzékenység (aggódásra való hajlam különféle nehézségekkel szemben), a Támaszkeresés (mások érzelmi támogatásának igénye) és az Érzelmi kötődés (erős érzelmi kötődés és empatikus érzékenység mások iránt).",
      },
      insights: {
      ...
      facets: [
        { code: "fearfulness", label: "Caution", labelByLocale: { en: "Caution", hu: "Óvatosság" } },
        { code: "anxiety", label: "Stress Sensitivity", labelByLocale: { en: "Stress Sensitivity", hu: "Stresszérzékenység" } },
        { code: "dependence", label: "Support Seeking", labelByLocale: { en: "Support Seeking", hu: "Támaszkeresés" } },
        { code: "sentimentality", label: "Emotional Bonding", labelByLocale: { en: "Emotional Bonding", hu: "Érzelmi kötődés" } },
      ],
    },
    {
      code: "TEMP",
      ...
      color: "#F59E0B",
      description: "A társas energia a hatfaktoros modellben a társas önbizalmat, a különféle szociális helyzetekben való komfortot, a társalgás és összejövetelek élvezetét, valamint az általános lelkesedést és energiát tükrözi. Négy facetje a Társas önbizalom (pozitív önkép, különösen társas helyzetekben), a Fellépés (magabiztosság csoportban vagy nyilvánosan), a Társaságkedvelés (a társalgás, interakciók és összejövetelek élvezete) és a Lendület (általános lelkesedés és optimizmus).",
      descriptionByLocale: {
        en: "Tempo — social energy — in the six-factor model reflects social self-confidence, comfort across social situations, enjoyment of conversation and social gatherings, and overall enthusiasm and energy. Its four facets are Social Confidence (positive self-regard, especially in social contexts), Presence (confidence in group or public settings), Sociability (enjoyment of conversation, interaction, and social gatherings), and Vitality (general sense of enthusiasm and optimism).",
        hu: "A társas energia a hatfaktoros modellben a társas önbizalmat, a különféle szociális helyzetekben való komfortot, a társalgás és összejövetelek élvezetét, valamint az általános lelkesedést és energiát tükrözi. Négy facetje a Társas önbizalom (pozitív önkép, különösen társas helyzetekben), a Fellépés (magabiztosság csoportban vagy nyilvánosan), a Társaságkedvelés (a társalgás, interakciók és összejövetelek élvezete) és a Lendület (általános lelkesedés és optimizmus).",
      },
      insights: {
      ...
      facets: [
        { code: "social_self_esteem", label: "Social Confidence", labelByLocale: { en: "Social Confidence", hu: "Társas önbizalom" } },
        { code: "social_boldness", label: "Presence", labelByLocale: { en: "Presence", hu: "Fellépés" } },
        { code: "sociability", label: "Sociability", labelByLocale: { en: "Sociability", hu: "Társaságkedvelés" } },
        { code: "liveliness", label: "Vitality", labelByLocale: { en: "Vitality", hu: "Lendület" } },
      ],
    },
    {
      code: "ADAP",
      ...
      color: "#34D399",
      description: "Az alkalmazkodás dimenzió (a harag ellenpontjaként) azt tükrözi, mennyire hajlamos valaki megbocsátani a sérelmeket, elnézően ítélni meg másokat, kompromisszumra törekedni, és megőrizni a nyugalmát provokáció esetén. Négy facetje a Megbocsátás (a bizalom és a szívélyesség helyreállítása az őt megbántókkal szemben), az Elfogadás (enyhe, toleráns ítélkezés másokról), a Rugalmasság (hajlandóság az alkalmazkodásra és a kompromisszumra) és a Türelem (a harag és az ingerültség visszafogása).",
      descriptionByLocale: {
        en: "The Adaptability dimension (versus Anger) reflects the tendency to forgive wrongs, judge others with leniency, willingness to compromise and cooperate, and the ability to keep one's temper even when mistreated. Its four facets are Forgivingness (restoring trust and goodwill toward those who have caused harm), Acceptance (mild and lenient judgment of others), Flexibility (willingness to adapt and compromise), and Patience (restraining anger and irritation).",
        hu: "Az alkalmazkodás dimenzió (a harag ellenpontjaként) azt tükrözi, mennyire hajlamos valaki megbocsátani a sérelmeket, elnézően ítélni meg másokat, kompromisszumra törekedni, és megőrizni a nyugalmát provokáció esetén. Négy facetje a Megbocsátás (a bizalom és a szívélyesség helyreállítása az őt megbántókkal szemben), az Elfogadás (enyhe, toleráns ítélkezés másokról), a Rugalmasság (hajlandóság az alkalmazkodásra és a kompromisszumra) és a Türelem (a harag és az ingerültség visszafogása).",
      },
      insights: {
      ...
      facets: [
        ...
        { code: "gentleness", label: "Acceptance", labelByLocale: { en: "Acceptance", hu: "Elfogadás" } },
    ...
    },
    {
      ...
      color: "#A78BFA",
      description: "A tervezettség dimenzió azt méri, mennyire szervezett és rendszeres valaki a mindennapi élete terén, mennyire kitartóan és fegyelmezetten törekszik a céljai elérésére, mennyire törekszik pontosságra és tökéletességre, és mennyire gondolja át alaposan a döntéseit. Négy facetje a Rendszerezettség (rendezett fizikai környezet és időbeosztás igénye), a Kitartás (erős munkamotiváció és kitartás), a Precizitás (aprólékosság és a részletekre való odafigyelés) és a Megfontoltság (impulzusok kontrollja, a döntések átgondolása).",
      descriptionByLocale: {
        en: "The Thoroughness dimension measures how organized and structured a person is, how persistently and disciplinedly they work toward goals, their drive for accuracy and thoroughness, and how carefully they deliberate before making decisions. Its four facets are Organization (preference for tidy surroundings and structured schedules), Persistence (strong work ethic and motivation to achieve), Precision (thoroughness and attention to detail), and Deliberation (impulse control and careful deliberation).",
        hu: "A tervezettség dimenzió azt méri, mennyire szervezett és rendszeres valaki a mindennapi élete terén, mennyire kitartóan és fegyelmezetten törekszik a céljai elérésére, mennyire törekszik pontosságra és tökéletességre, és mennyire gondolja át alaposan a döntéseit. Négy facetje a Rendszerezettség (rendezett fizikai környezet és időbeosztás igénye), a Kitartás (erős munkamotiváció és kitartás), a Precizitás (aprólékosság és a részletekre való odafigyelés) és a Megfontoltság (impulzusok kontrollja, a döntések átgondolása).",
      },
      insights: {
      ...
      facets: [
        { code: "organization", label: "Organization", labelByLocale: { en: "Organization", hu: "Rendszerezettség" } },
        { code: "diligence", label: "Persistence", labelByLocale: { en: "Persistence", hu: "Kitartás" } },
        { code: "perfectionism", label: "Precision", labelByLocale: { en: "Precision", hu: "Precizitás" } },
        { code: "prudence", label: "Deliberation", labelByLocale: { en: "Deliberation", hu: "Megfontoltság" } },
      ],
    },
    {
      code: "OPEN",
      ...
      color: "#38BDF8",
      description: "A nyitottság dimenzió az esztétikai fogékonyságot, az intellektuális kíváncsiságot, a kreativitást és a szokatlan ötletek iránti befogadóképességet méri. Négy facetje az Esztétikai fogékonyság (elmerülés a természet és a művészet szépségében), a Kíváncsiság (ismeretek és tapasztalatok aktív keresése), az Alkotókedv (az innováció és a kísérletezés iránti preferencia, eredeti megoldások keresése) és a Rendhagyó gondolkodás (nyitottság a szokatlan, esetleg radikális ötletekre).",
      descriptionByLocale: {
        en: "The Openness to Experience dimension measures aesthetic appreciation, intellectual curiosity, creativity, and receptiveness to unusual ideas and perspectives. Its four facets are Aesthetic Sensitivity (absorption in the beauty of art and nature), Curiosity (active seeking of knowledge and experience), Creativity (preference for innovation and experimentation, seeking original solutions), and Unconventional Thinking (openness to ideas that may seem strange or radical).",
      ...
      facets: [
        { code: "aesthetic_appreciation", label: "Aesthetic Sensitivity", labelByLocale: { en: "Aesthetic Sensitivity", hu: "Esztétikai fogékonyság" } },
        { code: "inquisitiveness", label: "Curiosity", labelByLocale: { en: "Curiosity", hu: "Kíváncsiság" } },
        { code: "creativity", label: "Creativity", labelByLocale: { en: "Creativity", hu: "Alkotókedv" } },
        { code: "unconventionality", label: "Unconventional Thinking", labelByLocale: { en: "Unconventional Thinking", hu: "Rendhagyó gondolkodás" } },
      ],
    },
    {
      code: "I",
      ...
      facets: [
        { code: "altruism", label: "Helpfulness", labelByLocale: { en: "Helpfulness", hu: "Segítőkészség" } },
      ],
    },
  ],
  questions: [
