...
/**
 * Context-adapted HEXACO (100 questions)
 */
export const hexacoModifiedConfig: TestConfig = {
  ...
  dimensions: [
    ...
    },
    {
      ...
      color: "#34D399",
      description: "Measures the extent to which you feel genuine sympathy for those who are less fortunate and are motivated to give generously to others in need.",
      descriptionByLocale: {
        en: "Measures the extent to which you feel genuine sympathy for those who are less fortunate and are motivated to give generously to others in need.",
        hu: "Azt méri, mennyire érzesz valódi együttérzést a kevésbé szerencsésekkel, és mennyire indít arra, hogy nagylelkűen segíts a rászorulókon.",
        de: "Misst, inwieweit du echtes Mitgefühl für weniger Glückliche empfindest und motiviert bist, anderen in Not großzügig zu helfen.",
      },
      insights: {
        low: "You feel little concern for others' misfortunes and are unlikely to go out of your way to help those in need.",
        mid: "You feel moderate sympathy for others and are sometimes moved to help, depending on the situation.",
        high: "You genuinely sympathize with those less fortunate and feel a strong inner drive to give generously and help others.",
      },
      insightsByLocale: {
        en: {
          low: "You feel little concern for others' misfortunes and are unlikely to go out of your way to help those in need.",
        ...
        hu: {
          low: "Kevéssé törődsz mások bajával, és nem valószínű, hogy saját komfortodból kilépve másokon segíts.",
          mid: "Mérsékelt együttérzést érzel mások iránt, és helyzettől függően néha segítőkész vagy.",
          high: "Valódi együttérzéssel fordulsz a nehéz sorsúak felé, és erős belső késztetést érzel a nagylelkűség és segítségnyújtás iránt.",
        },
        de: {
          low: "Du fühlst wenig Mitgefühl für das Unglück anderer und neigst nicht dazu, anderen uneigennützig zu helfen.",
          mid: "Du empfindest mäßiges Mitgefühl für andere und bist je nach Situation manchmal hilfsbereit.",
          high: "Du empfindest echtes Mitgefühl für Benachteiligte und spürst einen starken inneren Antrieb, großzügig zu sein und anderen zu helfen.",
        },
      },
      facets: [
