  ...
  questions: [
    {
      ...
      text: "Meglehetôsen untatna egy képtár meglátogatása.", 
      textByLocale: {
        hu: "Meglehetôsen untatna egy képtár meglátogatása.",
    ...
    },
    {
      ...
      dimension: "E", 
      facet: "fearfulness", 
      text: "Nyugtalansággal töltene el, ha rossz idôjárási körülmények között kellene utazást vállalnom.", 
      textByLocale: {
        hu: "Nyugtalansággal töltene el, ha rossz idôjárási körülmények között kellene utazást vállalnom.",
    ...
    },
    {
      ...
      dimension: "H", 
      facet: "sincerity", 
      text: "Ha valakitôl akit tulajdonképpen nem is kedvelek akarok valamit, célom érdekében képes vagyok ehhez a személyhez nagyon kedvesnek lenni.", 
      textByLocale: {
        hu: "Ha valakitôl akit tulajdonképpen nem is kedvelek akarok valamit, célom érdekében képes vagyok ehhez a személyhez nagyon kedvesnek lenni.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "diligence", 
      text: "A munkámban gyakran tûzök ki ambiciózus célokat magam elé.", 
      textByLocale: {
        hu: "A munkámban gyakran tûzök ki ambiciózus célokat magam elé.",
    ...
    },
    {
      ...
      dimension: "A", 
      facet: "gentleness", 
      text: "Az ismerôseim gyakran állítják, hogy túl kritikus vagyok másokhoz.", 
      textByLocale: {
        hu: "Az ismerôseim gyakran állítják, hogy túl kritikus vagyok másokhoz.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "perfectionism", 
      text: "Gyakran isméltelten is leellenôrzöm a munkám, hogy nincs-e mégis hiba benne.", 
      textByLocale: {
        hu: "Gyakran isméltelten is leellenôrzöm a munkám, hogy nincs-e mégis hiba benne.",
    ...
    },
    {
      ...
      text: "A radikális nézetekkel való foglalkozás egyszerûen idôpocsékolás.", 
      textByLocale: {
        hu: "A radikális nézetekkel való foglalkozás egyszerûen idôpocsékolás.",
    ...
    },
    {
      ...
      dimension: "A", 
      facet: "patience", 
      text: "Az emberek robbanékony természetûnek tartanak.", 
      textByLocale: {
        hu: "Az emberek robbanékony természetûnek tartanak.",
    ...
    },
    {
      ...
      dimension: "O", 
      facet: "aesthetic_appreciation", 
      text: "Nem fordítanám az idôm egy verses kötet olvasására.", 
      textByLocale: {
        hu: "Nem fordítanám az idôm egy verses kötet olvasására.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "organization", 
      text: "A dolgaimat elôre eltervezem, hogy elkerüljem az utolsó percben való kapkodást.", 
      textByLocale: {
        hu: "A dolgaimat elôre eltervezem, hogy elkerüljem az utolsó percben való kapkodást.",
    ...
    },
    {
      ...
      dimension: "H", 
      facet: "sincerity", 
      text: "Akkor sem hízelegnék a fônökömnek, ha tudnám, fizetésemelést vagy elôrelépest érnék el vele.", 
      textByLocale: {
        hu: "Akkor sem hízelegnék a fônökömnek, ha tudnám, fizetésemelést vagy elôrelépest érnék el vele.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "diligence", 
      text: "Céljaim elérésére gyakran minden erômet bevetem.", 
      textByLocale: {
        hu: "Céljaim elérésére gyakran minden erômet bevetem.",
    ...
    },
    {
      ...
      dimension: "H", 
      facet: "fairness", 
      text: "Szûkös anyagi helyzetben kísértésbe tudnék esni, hogy lopott árut vásároljak.", 
      textByLocale: {
        hu: "Szûkös anyagi helyzetben kísértésbe tudnék esni, hogy lopott árut vásároljak.",
    ...
    },
    {
      ...
      dimension: "O", 
      facet: "creativity", 
      text: "Szívesen alkotnék valami mûvészi munkát: egy regényt, zeneszámot, vagy festményt.", 
      textByLocale: {
        hu: "Szívesen alkotnék valami mûvészi munkát: egy regényt, zeneszámot, vagy festményt.",
    ...
    },
    {
      ...
      dimension: "H", 
      facet: "greed_avoidance", 
      text: "Szívesen laknék egy gazdag és elôkelô negyedben.", 
      textByLocale: {
        hu: "Szívesen laknék egy gazdag és elôkelô negyedben.",
    ...
    },
    {
      ...
      dimension: "O", 
      facet: "unconventionality", 
      text: "Nekem szimpatikusak azok az emberek, akiknek eredeti, az átlagtól eltérô nézeteik vannak.", 
      textByLocale: {
        hu: "Nekem szimpatikusak azok az emberek, akiknek eredeti, az átlagtól eltérô nézeteik vannak.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "prudence", 
      text: "Sok hibát követek el, mert elôbb cselekszem és csak aztán gondolkodom.", 
      textByLocale: {
        hu: "Sok hibát követek el, mert elôbb cselekszem és csak aztán gondolkodom.",
    ...
    },
    {
      ...
      dimension: "H", 
      facet: "sincerity", 
      text: "Ha valakitôl valamit akarok, akkor még a faviccein is képes vagyok nevetni.", 
      textByLocale: {
        hu: "Ha valakitôl valamit akarok, akkor még a faviccein is képes vagyok nevetni.",
    ...
    },
    {
      ...
      dimension: "O", 
      facet: "inquisitiveness", 
      text: "Egy, a tudomány és technika történetérôl szóló könyv, a végletekig untatna.", 
      textByLocale: {
        hu: "Egy, a tudomány és technika történetérôl szóló könyv, a végletekig untatna.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "diligence", 
      text: "Ha kitûzök egy célt magam elé, gyakran feladom mielôtt elérném.", 
      textByLocale: {
        hu: "Ha kitûzök egy célt magam elé, gyakran feladom mielôtt elérném.",
    ...
    },
    {
      ...
      dimension: "X", 
      facet: "social_boldness", 
      text: "Ha egy csoport tagja vagyok, gyakran leszek a szovivôje is.", 
      textByLocale: {
        hu: "Ha egy csoport tagja vagyok, gyakran leszek a szovivôje is.",
    ...
    },
    {
      ...
      dimension: "A", 
      facet: "flexibility", 
      text: "Ha azt mondják, hogy nincs igazam, az elsô reakciôm, hogy vitába szállok.", 
      textByLocale: {
        hu: "Ha azt mondják, hogy nincs igazam, az elsô reakciôm, hogy vitába szállok.",
    ...
    },
    {
      ...
      dimension: "E", 
      facet: "sentimentality", 
      text: "Nagyon megindít, ha hozzám közelálló személyektôl kell hosszútávra elbúcsúznom.", 
      textByLocale: {
        hu: "Nagyon megindít, ha hozzám közelálló személyektôl kell hosszútávra elbúcsúznom.",
    ...
    },
    {
      ...
      dimension: "A", 
      facet: "forgiveness", 
      text: "Nezemre esik teljes szívbôl megbocsátani, ha csúnyán megbántottak.", 
      textByLocale: {
        hu: "Nezemre esik teljes szívbôl megbocsátani, ha csúnyán megbántottak.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "diligence", 
      text: "Ami a munkát illeti, csak a legszükségesebb erôbedobással dolgozom.", 
      textByLocale: {
        hu: "Ami a munkát illeti, csak a legszükségesebb erôbedobással dolgozom.",
    ...
    },
    {
      ...
      dimension: "O", 
      facet: "creativity", 
      text: "Nem hiszem, hogy én egy kreatív vagy mûvészileg tehetséges típus vagyok.", 
      textByLocale: {
        hu: "Nem hiszem, hogy én egy kreatív vagy mûvészileg tehetséges típus vagyok.",
    ...
    },
    {
      ...
      dimension: "C", 
      facet: "prudence", 
      text: "Inkább spontán szeretek cselekedni, mint mindent elôre eltervezni.", 
      textByLocale: {
        hu: "Inkább spontán szeretek cselekedni, mint mindent elôre eltervezni.",
    ...
    },
    {
      ...
      dimension: "ALTRUISM", 
      facet: "altruism", 
      text: "Keményszívû embernek tartanak.", 
      textByLocale: {
        hu: "Keményszívû embernek tartanak.",
