...
const translations = {
  ...
  actions: {
    ...
    deleteProfile: { hu: "Profil törlése", en: "Delete profile", de: "Profil löschen" },
  ...
  landing: {
    heroTag: { hu: "Egyetemi kutatás", en: "University research", de: "Universitätsforschung" },
    heroTitle: {
      hu: "Segíts összehasonlítani a személyiségteszteket",
      en: "Help compare personality assessments",
      de: "Hilf beim Vergleich von Persönlichkeitstests",
    },
    heroTitleLine1: {
      hu: "Segíts összehasonlítani",
      en: "Help compare",
      de: "Hilf beim Vergleich von",
    },
    heroTitleLine2: {
      hu: "a személyiségteszteket",
      en: "personality assessments",
      de: "Persönlichkeitstests",
    },
    statsLanguages: { hu: "nyelv", en: "languages", de: "Sprachen" },
    heroBody: {
      hu: "Ez a felület egy szakdolgozat kutatásához készült. Célunk a HEXACO és Big Five modellek összehasonlítása önértékelés és ismerősi visszajelzés alapján.",
      ...
      de: "Diese Plattform unterstützt eine Abschlussarbeit. Ziel ist der Vergleich von HEXACO und Big Five auf Basis von Selbst- und Fremdeinschätzungen.",
    },
    joinResearch: { hu: "Részvétel a kutatásban", en: "Join the research", de: "An der Studie teilnehmen" },
    openDashboard: { hu: "Dashboard megnyitása", en: "Open dashboard", de: "Dashboard öffnen" },
    signIn: { hu: "Bejelentkezés", en: "Sign in", de: "Anmelden" },
    estimatedTime: {
      hu: "Becsült időtartam: kb. 10-15 perc. Az eredmények anonimizáltan kerülnek felhasználásra.",
      en: "Estimated time: about 10-15 minutes. Results are used in anonymized form.",
      de: "Geschätzte Dauer: ca. 10-15 Minuten. Ergebnisse werden anonymisiert verwendet.",
    },
    ...
    aboutTag: { hu: "A kutatásról", en: "About the research", de: "Über die Studie" },
    aboutTitle: { hu: "3 teszt, 1 kérdés", en: "3 tests, 1 question", de: "3 Tests, 1 Frage" },
    aboutBody: {
      hu: "Melyik személyiségteszt ad pontosabb képet? Segíts kideríteni a saját kitöltéseddel.",
    ...
    testTypes: { hu: "teszttípus", en: "test types", de: "Testtypen" },
    ...
    feature1Desc: {
      hu: "A HEXACO és Big Five modern személyiségmodellek - te is hozzájárulhatsz az összehasonlításhoz.",
    ...
    feature2Desc: {
      hu: "Kitöltés után azonnal látod a részletes profilod vizuális kiértékeléssel.",
      en: "You get a detailed visual profile right after completion.",
      de: "Du erhältst direkt nach dem Ausfüllen ein visuelles Detailprofil.",
    },
    feature3Title: { hu: "Ismerosi visszajelzés", en: "Observer feedback", de: "Fremdeinschätzung" },
    feature3Desc: {
    ...
    feature4Title: { hu: "Anonim adatkezelés", en: "Anonymous data handling", de: "Anonyme Datenverarbeitung" },
    feature4Desc: {
    ...
    feature5Title: { hu: "Mobilbarát élmény", en: "Mobile-friendly", de: "Mobilfreundlich" },
    feature5Desc: {
  ...
  dashboard: {
    ...
    journeyStepFeedback: { hu: "Visszajelzések", en: "Feedback", de: "Rückmeldungen" },
    ...
    overviewLikert: { hu: "A {count} dimenzió vizuális összefoglalása.", en: "Visual summary of {count} dimensions.", de: "Visuelle Zusammenfassung von {count} Dimensionen." },
    overviewMbti: { hu: "A négy dichotómia mentén elért eredményed.", en: "Your result across the four dichotomies.", de: "Dein Ergebnis entlang der vier Dichotomien." },
  ...
  profile: {
    ...
    localeTitle: { hu: "Nyelvi beállítások", en: "Language settings", de: "Spracheinstellungen" },
    localeBody: {
      hu: "Válaszd ki az alapértelmezett nyelvet. Ez lesz betöltve, ha bejelentkezel.",
      en: "Choose your default language. This will be loaded when you sign in.",
      de: "Wähle deine Standardsprache. Diese wird beim Anmelden geladen.",
    },
    deleteTitle: { hu: "Profil törlése", en: "Delete profile", de: "Profil löschen" },
    deleteBody: { hu: "A profil törlése végleges. A fiókod megszűnik.", en: "Deleting your profile is permanent. Your account will be removed.", de: "Das Löschen deines Profils ist dauerhaft. Dein Konto wird entfernt." },
    deleteError: { hu: "Nem sikerült törölni a profilt.", en: "Could not delete profile.", de: "Profil konnte nicht gelöscht werden." },
    confirmTitle: { hu: "Profil törlése", en: "Delete profile", de: "Profil löschen" },
