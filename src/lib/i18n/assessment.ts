export const assessmentTranslations = {
  ...
  teamRole: {
    ...
    selectHintPeer: { hu: "Jelöld ki a(z) {name} munkájára leginkább jellemző {min}–{max} állítást", en: "Select the {min}–{max} statements that best describe {name}" },
    highlightHintSelf: { hu: "Válaszd ki a {top} LEGjellemzőbbet", en: "Pick the {top} that fit you MOST" },
    highlightHintPeer: { hu: "Válaszd ki a(z) {name} esetében {top} LEGjellemzőbbet", en: "Pick the {top} that fit {name} MOST" },
  ...
  teamRolePeers: {
    ...
    nonePendingBody: { hu: "Ha egy mérés-sorozatban erre a lépésre érsz, itt tudod majd kitölteni.", en: "When a measurement series reaches this step, you'll fill it in here." },
