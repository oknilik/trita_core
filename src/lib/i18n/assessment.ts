export const assessmentTranslations = {
  assessment: {
    ...
    progressLabel: { hu: "{done}. kérdés / összesen {total}", en: "Question {done} of {total}" },
    // P1.5: a szerver-oldali draft-mentés hibája többé nem néma.
    saveErrorHint: {
      hu: "Most nem sikerült menteni a szerverre. A válaszaid ezen az eszközön megmaradtak. A következő válasznál újra megpróbáljuk a mentést.",
    ...
    introInfoGuest: {
      hu: "Bármikor szünetet tarthatsz. A válaszaidat ebben a böngészőben mentjük, így itt később folytathatod a kitöltést. Másik eszközön vagy a böngészési adatok törlése után nem éred el őket. Regisztráció után az eredményed a fiókodba kerül.",
    ...
    introAutoAdvanceHint: {
      hu: "Válaszadás után automatikusan megjelenik a következő kérdés. Ezt a beállítást bármikor kikapcsolhatod, ha több időt szeretnél hagyni magadnak.",
    ...
    questionCounter: { hu: "{current}. kérdés / {total}", en: "Question {current} / {total}" },
    evaluatingTitle: { hu: "Készítjük a személyiségprofilodat.", en: "Your personal pattern is taking shape." },
    evaluatingBody: { hu: "Egy pillanat, és megmutatjuk az eredményedet.", en: "One moment while we turn your answers into useful patterns." },
    ...
    focusMode: { hu: "Kérdésenkénti nézet", en: "Focus mode" },
    ...
    questionProgress: { hu: "{current}. kérdés / {total}", en: "Question {current} / {total}" },
    savedState: { hu: "Mentve", en: "Saved" },
    savedStateGuest: { hu: "Mentve ebben a böngészőben", en: "Saved in this browser" },
    missingAnswerToast: {
      hu: "Egy kérdésre még nem válaszoltál. Most ezt mutatjuk.",
      en: "One question was missed – we brought you back to it.",
    },
    checkpointReached: { hu: "A kérdések {percent}%-ára már válaszoltál.", en: "{percent}% done - great pace!" },
    ...
    journeyMilestone25: { hu: "Már a kérdések negyedére válaszoltál.", en: "Good start – you're a quarter through!" },
    ...
    journeyMilestone50: { hu: "A kérdések felére már válaszoltál.", en: "Halfway there – great progress!" },
    journeyMilestone50Sub: { hu: "Az eddigi válaszaidat elmentettük. Folytasd a saját tempódban.", en: "Your profile is starting to take shape. Keep the momentum going!" },
  ...
  teamRole: {
    ...
    errorBody: {
      hu: "A válaszaid megmaradtak ezen az oldalon. Próbáld újra elküldeni őket.",
  ...
  teamRolePeers: {
    ...
    introBody: { hu: "Minden csapattársadról {count} rövid állítás közül választod ki azokat, amelyek a leginkább jellemzik őt. A kitöltés fejenként körülbelül 3–4 perc.", en: "For each teammate you'll pick the statements that describe them best from {count} short items – about 3-4 minutes each." },
    ...
    doneBody: { hu: "A csapattársaid összesített visszajelzést kapnak. A te válaszaidat is név nélkül, összesítve használjuk fel.", en: "Your teammates will receive an aggregated view – your answers blend in anonymously." },
    ...
    nonePendingBody: { hu: "Amikor a mérési sorozatban megnyílik ez a lépés, itt töltheted ki a kérdőívet.", en: "When a measurement series reaches this step, you'll fill it in here." },
  ...
  trustPeers: {
    ...
    doneBody: { hu: "A csapat dinamikatérképe mostantól mért kapcsolati adatra épülhet a becslés helyett.", en: "The team's dynamics map can now build on measured relationship data instead of estimates." },
    backToDashboard: { hu: "Vissza a vezérlőre", en: "Back to dashboard" },
  ...
  observer: {
    ...
    completeBody: { hu: "Ezt a meghívót már felhasználták. Köszönjük a részvételt!", en: "This invite link has already been used. Thank you for participating!" },
    inactiveTitle: { hu: "A meghívó már nem aktív", en: "Invite is no longer active" },
    inactiveBody: { hu: "Ezt a meghívót visszavonták. Kérj új linket az ismerősödtől.", en: "This invite was canceled. Ask for a new link." },
    ...
    introInvitedBy: { hu: "{inviter} arra kér, hogy adj róla visszajelzést a kérdőív kitöltésével.", en: "{inviter} asked you to fill in their personality test." },
    ...
    introPauseNote: { hu: "A kérdőív {count} kérdésből áll. Bármikor szünetet tarthatsz: mentjük a válaszaidat, és később ott folytathatod, ahol abbahagytad.", en: "😅 We know, {count} questions is a lot. But you can stop anytime – your progress saves automatically so you can pick up right where you left off." },
    ...
    introMeta: {
      hu: "{count} kérdés · bármikor folytatható · név nélkül",
      en: "{count} questions · continue anytime · anonymous",
    },
    ...
    thinkOf: {
      hu: "A kérdések róla szólnak: {inviter}. Válaszadáskor a vele kapcsolatos tapasztalataidra gondolj.",
    ...
    selectBothFields: { hu: "A folytatáshoz add meg, milyen kapcsolatban álltok, és mióta ismeritek egymást.", en: "Please select a relationship and duration to continue." },
  },
  tryClaim: {
    error: {
  ...
  tryComplete: {
    ...
    partialBody: {
      hu: "Néhány kérdés még hátravan. Folytasd ott, ahol abbahagytad, és a végén rögtön megmutatjuk az eredményed rövid összefoglalóját.",
  ...
  psafety: {
    ...
    anonBody: {
      hu: "A válaszaidat nem kapcsoljuk a nevedhez. Csak a csapat összesített eredménye látható, legalább 3 kitöltés után. Piszkozatot nem mentünk, ezért ezt a kérdőívet egy alkalommal kell kitöltened.",
    ...
    nonePendingBody: {
      hu: "Jelenleg nincs kitöltésre váró kérdőíved a pszichológiai biztonság felmérésében. Lehet, hogy már válaszoltál, vagy a mérés lezárult.",
  ...
  myTasks: {
    ...
    observerGatheringBadge: { hu: "Külső visszajelzések gyűjtése folyamatban", en: "Collecting outside feedback" },
