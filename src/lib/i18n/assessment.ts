export const assessmentTranslations = {
  assessment: {
    ...
    introStep2: { hu: "Személyiségprofil", en: "Personality profile" },
    ...
    scale1: { hu: "Egyáltalán nem igaz", en: "Not at all true" },
    scale2: { hu: "Inkább nem igaz", en: "Mostly untrue" },
    scale3: { hu: "Részben igaz", en: "Partly true" },
    scale4: { hu: "Inkább igaz", en: "Mostly true" },
    scale5: { hu: "Teljesen igaz", en: "Completely true" },
    endLeft: { hu: "Egyáltalán nem igaz", en: "Not at all true" },
    endRight: { hu: "Teljesen igaz", en: "Completely true" },
    questionCounter: { hu: "Kérdés {current} / {total}", en: "Question {current} / {total}" },
    evaluatingTitle: { hu: "Összeáll a saját mintázatod.", en: "Your personal pattern is taking shape." },
    evaluatingBody: { hu: "Egy pillanat, és megmutatjuk a használható összefüggéseket.", en: "One moment while we turn your answers into useful patterns." },
  ...
  trustPeers: {
    ...
    start: { hu: "Elkezdem", en: "Start" },
    progress: { hu: "{done} / {total} csapattárs kész", en: "{done} / {total} teammates done" },
    aboutPerson: { hu: "Most róla válaszolsz", en: "You are answering about" },
    personReminder: { hu: "A következő kérdések mind rá vonatkoznak.", en: "All of the following questions are about this teammate." },
    currentPerson: { hu: "{current} / {total} · aktuális kolléga", en: "{current} / {total} · current teammate" },
    answerProgress: { hu: "{done} / {total} válasz", en: "{done} / {total} answered" },
    answered: { hu: "Megválaszolva", en: "Answered" },
  ...
  observer: {
    ...
    flowAvailableTitle: { hu: "Megérkezett a külső visszajelzésed", en: "Your outside feedback has arrived" },
    flowAvailableBody: { hu: "{count} visszajelzés érkezett a csapatfolyamatban. Az önképed és az összesített külső kép összevetése elérhető.", en: "You received {count} responses in the team process. You can now compare your self-image with the combined outside view." },
    flowOpenComparison: { hu: "Összevetés megnyitása", en: "Open comparison" },
    flowEyebrow: { hu: "Csapatfolyamat", en: "Team process" },
    flowProgressTitle: { hu: "Külső visszajelzés – folyamatban", en: "Outside feedback – in progress" },
    flowCampaign: { hu: "Aktív mérés: {name}", en: "Active measurement: {name}" },
    flowProgressBody: { hu: "A tanácsadó elindította a mérést. Most te választod ki az értékelőidet: az alábbi meghívókezelőből kérj visszajelzést kollégáktól vagy külső ismerősöktől.", en: "Your consultant has started the measurement. You now choose your raters: use the invitation controls below to ask colleagues or people outside the organization." },
    flowAccessBody: { hu: "A név szerint felkért kolléga a saját fiókjával jelentkezik be. A külső értékelő belépés nélkül, a jóváhagyott meghívó linkjén tölthet ki.", en: "A named colleague signs in with their own account. An external rater can respond without signing in, using the approved invitation link." },
    flowRevealBody: { hu: "Az összevetés legalább {count} beérkezett visszajelzésnél nyílik meg. A válaszok összesítve, az értékelők neve nélkül jelennek meg.", en: "The comparison opens after at least {count} responses. Answers are shown together, without the raters’ names." },
    flowLockedTitle: { hu: "A külső visszajelzés a csapatfolyamat része", en: "Outside feedback is part of the team process" },
    flowLockedBody: { hu: "A következő mérést a program tanácsadója indítja el. Addig nincs meghívási teendőd. Indulás után itt választod ki és kéred fel az értékelőidet, majd itt követheted a válaszok beérkezését.", en: "Your program consultant starts the next measurement. There is no invitation task yet. Once it starts, you choose and invite your raters here, then track incoming responses." },
    flowSelfComplete: { hu: "Saját eredményed kész", en: "Your own result is complete" },
    flowSelfCompleteBody: { hu: "A saját eredményed már teljes; a külső visszajelzés új nézőpontot ad hozzá.", en: "Your own result is already complete; outside feedback adds another perspective." },
    flowStripAvailable: { hu: "Külső visszajelzés megérkezett ({count}) – összevetés", en: "Outside feedback arrived ({count}) – comparison" },
    flowStripProgress: { hu: "Külső visszajelzés folyamatban ({count}/{min})", en: "Outside feedback in progress ({count}/{min})" },
    flowStripLocked: { hu: "Külső visszajelzés: a tanácsadó indítására vár", en: "Outside feedback: waiting for your consultant to start" },
    introResumeInternal: { hu: "A mentett válaszaidat ezen a linken, ugyanazzal a fiókkal belépve folytathatod a meghívó lejáratáig.", en: "Resume your saved answers at this link, signed in to the same account, until the invitation expires." },
    introResumeExternal: { hu: "Ezen a linken, ebben a böngészőben folytathatod a mentett válaszaidat a meghívó lejáratáig. Másik eszközön vagy a böngészési adatok törlése után elölről kell kezdened.", en: "Resume your saved answers at this link in this browser until the invitation expires. On another device, or after clearing browser data, you will need to start again." },
    introTitle: { hu: "Visszajelzés", en: "Feedback" },
    ...
    introPauseNote: { hu: "{count} kérdés. A mentett válaszaidat ezen a linken, ebben a böngészőben folytathatod a meghívó lejáratáig.", en: "There are {count} questions. Resume your saved answers at this link in this browser until the invitation expires." },
    introEyebrow: { hu: "Személyes meghívás", en: "Personal invitation" },
    introHeroTitle: { hu: "A te nézőpontod is számít.", en: "Your perspective matters." },
    introHeroBody: {
      hu: "Egy rövid személyiségteszt, amely segít pontosabban látni, hogyan működik {inviter}.",
      en: "A short personality assessment that helps build a clearer picture of how {inviter} works.",
    },
    introInviterMeta: { hu: "{inviter} meghívott", en: "{inviter} invited you" },
    introAnonymousMeta: { hu: "név nélküli visszajelzésre", en: "to give anonymous feedback" },
    introFormEyebrow: { hu: "Mielőtt elkezded · 1 perc", en: "Before you begin · 1 minute" },
    introFormTitle: { hu: "Segíts értelmezni a válaszaidat", en: "Help us understand your answers" },
    introFormBody: {
      hu: "Válaszd ki, milyen kapcsolatban álltok. A válaszaid nem jelennek meg a neveddel.",
      en: "Tell us how you know each other. Your answers will not be shown with your name.",
    },
    introMeta: {
      hu: "{count} kérdés · összesített, név nélküli visszajelzés",
      en: "{count} questions · combined, anonymous feedback",
    },
