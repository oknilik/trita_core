export const assessmentTranslations = {
  ...
  trustPeers: {
    ...
    consentBody: { hu: "A válaszaidat a rendszer tárolja, de a csapattársaid nem látják őket. A vezető és a tanácsadó a dinamika-térképen páronként összevont képet lát (a két irány átlagát), és páros érték CSAK akkor jelenik meg, ha mindkét irányból van válasz — az egyéni válaszod önmagában sehol nem látszik, a rólad szóló összesített kép pedig csak legalább 3 értékelőnél áll össze.", en: "Your answers are stored but never shown to your teammates. The leader and the consultant see a combined per-pair view on the dynamics map (the average of both directions), and a pair value only appears once BOTH directions have answered — your individual answers are never displayed on their own, and any aggregate about you only forms with at least 3 raters." },
    start: { hu: "Elkezdem", en: "Start" },
    progress: { hu: "{done} / {total} csapattárs kész", en: "{done} / {total} teammates done" },
