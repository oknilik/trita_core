export const resultsTranslations = {
  ...
  results: {
    ...
    heroGlyphOpen: { hu: "Fordíts meg", en: "Flip me" },
    heroGlyphBack: { hu: "Profilom", en: "My profile" },
    heroGlyphOpenA11y: { hu: "Karakterábra megnyitása", en: "Open character visual" },
    heroGlyphBackA11y: { hu: "Profiloldal megnyitása", en: "Open profile side" },
