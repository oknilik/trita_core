export const resultsTranslations = {
  ...
  results: {
    ...
    heroGlyphOpen: { hu: "Karakterlap", en: "Character card" },
    heroGlyphBack: { hu: "Profillap", en: "Profile card" },
    heroGlyphOpenA11y: { hu: "Karakterlap megjelenítése", en: "Show character card" },
    heroGlyphBackA11y: { hu: "Profillap megjelenítése", en: "Show profile card" },
