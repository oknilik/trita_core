export const resultsTranslations = {
  ...
  results: {
    ...
    summaryDetailsPrompt: { hu: "Kíváncsi vagy, mi van a számok mögött?", en: "Curious what sits behind the scores?" },
    summaryDetailsBody: {
    ...
    detailsExtensionsTitle: { hu: "További felfedezési irányok", en: "Further ways to explore" },
    detailsExtensionsBody: { hu: "Kapcsolati dinamika és karrierilleszkedés — akkor nyisd meg, ha tovább vinnéd a felismeréseket.", en: "Interaction dynamics and career fit — open when you want to take the insights further." },
    ...
    reportChaptersTitle: { hu: "Haladj végig a fejezeteken", en: "Explore the report chapter by chapter" },
    reportChapterOpen: { hu: "Nyitva", en: "Open" },
    reportChapterClosed: { hu: "Megnyitás", en: "Open" },
    reportChapterNext: { hu: "Következő fejezet", en: "Next chapter" },
    reportOverviewTitle: { hu: "Áttekintés", en: "Overview" },
    reportOverviewBody: { hu: "A karakterképed, a radar és a hat fő dimenzió egy képernyőn.", en: "Your character visual, radar and six main dimensions in one place." },
