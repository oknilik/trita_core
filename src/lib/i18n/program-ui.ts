export const programUiTranslations = {
  programUi: {
    ...
    saveError: {
      hu: "A mentés nem sikerült. Ellenőrizd a jogosultságot és a kiinduló mérést, majd próbáld újra.",
    ...
    unsupported: {
      hu: "Nem támogatott programverzió.",
      en: "Unsupported program version.",
    },
    programs: {
      hu: "Mérési programok",
      en: "Measurement programs",
    },
    openBaseline: {
      hu: "Kiinduló mérés megnyitása",
    ...
    reviewChecksData: {
      hu: "A riport adatait jóváhagyáskor ellenőrizzük",
      en: "Report data is checked at review",
    },
    activate: {
      hu: "Program aktiválása",
      en: "Activate program",
    },
    close: {
      hu: "Mérés lezárása",
      en: "Close measurement",
    },
    generateReport: {
      hu: "Riport készítése és jóváhagyása",
      en: "Generate and review report",
    },
    psychSafety: {
      hu: "Pszichológiai biztonság",
      en: "Psychological safety",
    },
    comparisonTitle: {
      hu: "Változás a kiinduló méréshez képest",
