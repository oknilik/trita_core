export const orgTranslations = {
  ...
  dashboard: {
    ...
    teamPatternView: { hu: "Megtekintés", en: "Open" },
    activityCompleted: { hu: "kitöltötte a személyiségtesztet", en: "completed the assessment" },
    activityJoined: { hu: "csatlakozott", en: "joined" },
    bestNextStep: { hu: "Ma innen érdemes továbbmenni", en: "Best next step today" },
    reminderFallbackDesc: { hu: "Küldd el az emlékeztetőt a {teamName} csapat hiányzó tagjainak, hogy a csapatkép ezen a héten elkészülhessen.", en: "Send reminders to missing members in {teamName} so the team pattern can unlock this week." },
    reminderFallbackPrimary: { hu: "Emlékeztető küldése", en: "Send reminder" },
    snapshotFallbackDesc: { hu: "A csapatkép elérhető — érdemes most megnézni és megosztani a csapattal.", en: "Team pattern is available — review and share it with the team." },
    snapshotFallbackPrimary: { hu: "Csapatkép megtekintése", en: "Open team pattern" },
    campaignFallbackDesc: { hu: "Indíts el egy visszajelzési kört — a 360°-os visszajelzés elérhető.", en: "Start a feedback round — 360 feedback is available." },
    campaignFallbackPrimary: { hu: "Visszajelzési kör indítása", en: "Start feedback round" },
    recommendedNextStep: { hu: "Ajánlott következő lépés", en: "Recommended next step" },
    openOrgCockpit: { hu: "Szervezeti cockpit megnyitása", en: "Open organization cockpit" },
    ...
    openAttentionPoints: { hu: "{count} nyitott figyelmi pont", en: "{count} open attention point(s)" },
    ...
    recommendedStep: { hu: "Ajánlott következő lépés", en: "Recommended next step" },
    ...
    needsAttention: { hu: "Figyelmet kér", en: "Needs attention" },
    noOpenActions: { hu: "Nincs nyitott teendő!", en: "No open actions." },
