export const orgTranslations = {
  teamCommitmentsEntry: {
    tab: { hu: "Vállalások", en: "Commitments" },
    navigation: { hu: "A csapat nézetei", en: "Team views" },
    open: { hu: "Vállalások megnyitása", en: "Open commitments" },
    openItem: { hu: "Vállalás megnyitása", en: "Open commitment" },
    overviewTitle: { hu: "A felismerésekből közös lépések", en: "Turn insights into shared steps" },
    nextForTeam: { hu: "A csapat következő lépése", en: "The team's next step" },
    nextForYou: { hu: "A te következő lépésed", en: "Your next step" },
    openCount: { hu: "{count} nyitott vállalás a csapatban", en: "{count} open team commitments" },
    ownOpenCount: { hu: "{count} nyitott vállalásod van", en: "You have {count} open commitments" },
    emptyManager: { hu: "Még nincs közösen rögzített vállalás. Adj hozzá egy következő lépést felelőssel és határidővel.", en: "No shared commitments yet. Add a next step with an owner and due date." },
    emptyMember: { hu: "A közösen egyeztetett vállalások itt jelennek majd meg. A hozzád rendelt lépések előrehaladását a Vállalások fülön jelezheted.", en: "Shared commitments will appear here. Update the steps assigned to you in the Commitments tab." },
    emptyReadOnly: { hu: "Még nincs rögzített közös vállalás. A Vállalások felülete jelenleg csak olvasható.", en: "No shared commitments have been recorded yet. The Commitments workspace is currently read-only." },
    noOwn: { hu: "Jelenleg nincs hozzád rendelt nyitott vállalás. A csapat közös lépéseit továbbra is megtekintheted.", en: "You have no open commitments assigned to you. You can still view the team's shared steps." },
    allDone: { hu: "Minden rögzített vállalás lezárult. A tapasztalatok és az előzmények a Vállalások fülön megmaradnak.", en: "All recorded commitments are complete. Experiences and history remain in the Commitments tab." },
    importAvailable: { hu: "A publikált riportból {count} javaslat emelhető át. Válasszátok ki, melyikből lesz közös vállalás.", en: "{count} suggestions are available from published reports. Choose which ones become shared commitments." },
    create: { hu: "Első vállalás rögzítése", en: "Add the first commitment" },
    import: { hu: "Riportjavaslatok áttekintése", en: "Review report suggestions" },
    blocked: { hu: "Segítséget kér", en: "Needs help" },
    overdue: { hu: "A határidő elmúlt", en: "Past due" },
    unassigned: { hu: "Felelős kijelölésére vár", en: "Awaiting an owner" },
    stale: { hu: "Több mint egy hete nincs frissítés", en: "No update for more than a week" },
    inProgress: { hu: "Folyamatban", en: "In progress" },
    planned: { hu: "Tervezett lépés", en: "Planned step" },
    owner: { hu: "Felelős: {name}", en: "Owner: {name}" },
    due: { hu: "Határidő: {date}", en: "Due: {date}" },
    checkIn: { hu: "Közös ránézés: {date}", en: "Team check-in: {date}" },
    reportTitle: { hu: "A vállalások innen folytatódnak", en: "Continue with shared commitments" },
    reportDescription: { hu: "Ez a riport a publikáláskor rögzített képet őrzi. Az egyeztetett felelősöket, az előrehaladást és a közös ránézést a Vállalások fülön követitek.", en: "This report preserves the picture at publication. Follow agreed owners, progress and team check-ins in the Commitments tab." },
    workshopTitle: { hu: "Rögzítsétek a közös következő lépést", en: "Record the agreed next step" },
    workshopDescription: { hu: "A workshopon egyeztetett vállalásoknak legyen kijelölt felelőse, határideje és megfigyelhető eredménye. Az élő követést a közös Vállalások felületen folytassátok.", en: "Give agreed workshop commitments an owner, due date and observable outcome. Continue tracking them in the shared Commitments workspace." },
    snapshotTitle: { hu: "A riportban rögzített akcióterv", en: "Action plan recorded in this report" },
    reportSuggestions: { hu: "A riport akciójavaslatai", en: "Report action suggestions" },
    snapshotDescription: { hu: "Publikáláskori pillanatkép, 30 / 60 / 90 napos bontásban. Az aktuális előrehaladás a Vállalások fülön látható.", en: "A snapshot at publication, across 30 / 60 / 90 days. Current progress is available in the Commitments tab." },
    draftDescription: { hu: "A riporthoz készülő javaslatok, 30 / 60 / 90 napos bontásban. Publikálás után a kiválasztott lépések külön emelhetők át a közös Vállalások közé.", en: "Report suggestions across 30 / 60 / 90 days. After publication, selected steps can be imported into shared Commitments." },
    unavailableTitle: { hu: "A vállalások most nem érhetők el", en: "Commitments are currently unavailable" },
    unavailableDescription: { hu: "A betöltés nem sikerült. Nyisd meg újra a Vállalások fület, vagy térj vissza a csapat áttekintéséhez.", en: "Loading failed. Reopen the Commitments tab or return to the team overview." },
    accessDescription: { hu: "A vállalások megtekintéséhez részletes csapathozzáférés szükséges. A hozzáférés helyreállítása után itt folytathatjátok a közös munkát.", en: "Viewing commitments requires detailed team access. You can continue here once access is restored." },
    backOverview: { hu: "Vissza az áttekintéshez", en: "Back to overview" },
  },
  teamReportReading: {
  ...
  advisory: {
    ...
    upgradeFeature5: {
      hu: "Teljes platform-hozzáférés (hőtérkép, csapatmintázat, feszültségpárok)",
  ...
  org: {
    ...
    campaign: {
      ...
      deleteConfirm: {
        hu: "Biztosan törlöd ezt a mérést? A kör MINDEN beadott értékelése (bizalmi, szerep-visszajelzés, elismerés, pulzusmérés) véglegesen törlődik, és a mérés a lezárt körök közt sem jelenik meg többé. A tagok saját eredményei (személyiség-teszt, szerep-kérdőív) megmaradnak.",
  ...
  campaignWiz: {
    ...
    typePsychName: { hu: "Pszichológiai biztonság pulzusmérése", en: "Psychological safety pulse" },
    typePsychDesc: {
  ...
  teamComp: {
    ...
    noDynamicsDesc: {
      hu: "Indíts szakmai visszajelzési kört a dinamika-térkép feltöltéséhez",
