export const orgTranslations = {
  advisory: {
    ...
    subtitleAdvisory: {
      hu: "A negyedéves tanácsadói konzultáción személyesen értelmezzük a csapataid mintázatait, és konkrét akcióterveket dolgozunk ki.",
    ...
    feature1Desc: {
      hu: "Átnézzük az összes csapatod mintázatát együtt: hol van összhang a csapatok között, hol vannak szervezeti szintű feszültségek, és melyik csapat mintázata jelent kockázatot a stratégiátok szempontjából.",
    ...
    feature4Title: {
      hu: "Írásos összefoglaló + csapat-riportok",
      en: "Written summary + team reports",
    },
    feature4Desc: {
      hu: "48 órán belül kapsz egy PDF-et: szervezeti hőtérkép vizualizáció, csapatonkénti 2-3 soros értékelés, a megbeszélt akciók listája felelőssel és határidővel, és a következő mérési pont javaslat.",
    ...
    howItWorks: {
      hu: "Hogyan működik a negyedéves konzultáció",
      en: "How the quarterly consultation works",
    },
    step1Title: {
      hu: "Előkészítés (aszinkron)",
    ...
    step2Title: {
      hu: "Stratégiai session (90 perc, online)",
      en: "Strategy session (90 min, online)",
    },
    step2Body: {
    ...
    step3Body: {
      hu: "PDF dokumentum: szervezeti hőtérkép, csapatonkénti rövid értékelés, a megbeszélt akciók listája felelőssel és határidővel, következő mérési pont javaslat. Azonnal továbbítható a menedzsment meetingre.",
    ...
    deepDiveTitle: {
      hu: "Csapat deep-dive session",
      en: "Team deep-dive session",
    },
    deepDiveDesc: {
      hu: "Ha egy konkrét csapat mélyebb elemzést igényel — személyre szabott 60 perces session a csapatmenedzserrel.",
      en: "If a specific team needs deeper analysis — a personalised 60-minute session with the team manager.",
    },
    deepDivePrice: {
      hu: "alkalom",
      en: "session",
    ...
    ctaAdvisoryBody: {
      hu: "Az Advisory csomagod tartalmazza a negyedéves szervezeti szintű tanácsadói konzultációt. Kattints az alábbi gombra, és 24 órán belül egyeztetünk időpontot. A csapataid adatai automatikusan rendelkezésre állnak — nem kell semmit előkészítened.",
      en: "Your Advisory plan includes the quarterly org-level consultation. Click and we'll confirm a time within 24 hours. Your team data is automatically available — no preparation needed.",
    },
    sending: {
      hu: "Küldés...",
      en: "Sending...",
    ...
    upgradeDesc: {
      hu: "Negyedéves személyes tanácsadói konzultáció + teljes platform hozzáférés. A csapatod adataiból konkrét, végrehajtható akcióterveket készítünk együtt.",
    ...
    upgradeFeature3: {
      hu: "Cross-team dinamikák és feszültségpontok elemzése",
      en: "Cross-team dynamics and tension point analysis",
    },
    upgradeFeature4: {
      hu: "3-5 konkrét szervezeti szintű akcióterv negyedévenként",
      en: "3-5 concrete org-level action plans per quarter",
    },
    upgradeFeature5: {
      hu: "Teljes platform hozzáférés (heatmap, mintázat, tension pair)",
      en: "Full platform access (heatmap, pattern, tension pair)",
    },
    upgradeFeature6: {
      hu: "Opcionális csapat deep-dive session (+€200/alkalom)",
      en: "Optional team deep-dive session (+€200/session)",
    },
    pricePerMonth: {
      hu: "/hó + €400/negyedév",
      en: "/mo + €400/quarter",
    ...
    foundingCustomer: {
      hu: "Founding customer? Az első 10 ügyfélnek €99/hó, örökre.",
      en: "Founding customer? €99/mo forever for the first 10 clients.",
    },
    upgradeButton: {
    ...
    faqA1: {
      hu: "Nem — a szervezeted összes csapatának mérési adatai, mintázatai és tension pair-jei automatikusan rendelkezésre állnak. Ha van konkrét kérdésed vagy helyzeted, azt előre jelezheted, de nem kötelező.",
    ...
    faqA2: {
      hu: "A negyedéves konzultáció szervezeti szintű: az összes csapat mintázatát áttekintjük, a cross-team dinamikákat, és szervezeti szintű akcióterveket készítünk. Ha egy konkrét csapat mélyebb elemzést igényel, ahhoz csapat deep-dive session foglalható (+€200/alkalom).",
      en: "The quarterly consultation is org-level: we review all team patterns, cross-team dynamics, and create org-level action plans. If a specific team needs deeper analysis, a team deep-dive session can be booked (+€200/session).",
    },
    faqQ3: {
    ...
    faqA3: {
      hu: "Általában te (vezető, HR, vagy az ügyvezető) és a Trita tanácsadó. A csapatmenedzsereket nem kell bevonni — ők a platformon kapják meg a saját csapatuk insight-jait.",
    ...
    faqA4: {
      hu: "48 órán belül egy írásos összefoglalót és akciótervet küldünk PDF-ben: szervezeti hőtérkép, csapatonkénti rövid értékelés, a megbeszélt akciók felelőssel és határidővel, és a következő mérési pont javaslat. Azonnal továbbítható a menedzsment meetingre.",
    ...
    faqA5: {
      hu: "Az Advisory csomagban negyedévente 1 szervezeti szintű session. Ezen felül csapat deep-dive session-ök és extra szervezeti session-ök igény szerint foglalhatók.",
      en: "The Advisory plan includes one org-level session per quarter. Additional team deep-dive and extra org sessions can be booked on request.",
    },
    faqQ6: {
      hu: "Mi történik, ha az Essentials csomagom van?",
      en: "What if I'm on the Essentials plan?",
    },
    faqA6: {
      hu: "Az Essentials csomag a platform teljes hozzáférését adja — csapatminta, heatmap, tension pair —, de nem tartalmaz személyes tanácsadói konzultációt. Az Advisory csomagra bármikor válthatál, a különbözet prorated.",
      en: "The Essentials plan gives full platform access — team pattern, heatmap, tension pair — but doesn't include personal advisory consultations. You can upgrade to Advisory at any time, billed prorated.",
    },
  },
  admin: {
  ...
  org: {
    ...
    settings: {
      ...
      extraSeatsInfo: { hu: "+{extra} extra hely · {extra} × €19/hó a következő számlán", en: "+{extra} extra seat{plural} · {extra} × €19/mo on next invoice" },
      ...
      upgradeHint: { hu: "Az Org csomag 40 helyet tartalmaz €149/hó áron.", en: "The Org plan includes 40 seats for €149/mo." },
    ...
    campaign: {
      ...
      hexacoA: { hu: "Barátságosság", en: "Agreeableness" },
    ...
    // ── Billing tab ─────────────────────────────────────────────────────
    billing: {
      currentPlanEyebrow: { hu: "// jelenlegi csomag", en: "// current plan" },
      currentPlanTitle: { hu: "Előfizetés", en: "Subscription" },
      statusActive: { hu: "Aktív", en: "Active" },
      statusTrialing: { hu: "Próbaidőszak", en: "Trial" },
      statusPastDue: { hu: "Fizetési hiba", en: "Past due" },
      statusCanceled: { hu: "Lemondva", en: "Canceled" },
      statusNone: { hu: "Nincs előfizetés", en: "No subscription" },
      planTeam: { hu: "Team csomag", en: "Team plan" },
      planOrg: { hu: "Org csomag", en: "Org plan" },
      planScale: { hu: "Scale csomag", en: "Scale plan" },
      planNone: { hu: "Nincs aktív csomag", en: "No active plan" },
      intervalMonthly: { hu: "Havi számlázás", en: "Monthly billing" },
      intervalAnnual: { hu: "Éves számlázás", en: "Annual billing" },
      nextBilling: { hu: "Következő számlázás", en: "Next billing" },
      trialDays: { hu: "{days} nap van hátra", en: "{days} days remaining" },
      seatsUsed: { hu: "{used} / {total} hely használatban", en: "{used} / {total} seats used" },
      manageBtn: { hu: "Számlázás kezelése", en: "Manage billing" },
      changePlanBtn: { hu: "Csomag váltás", en: "Change plan" },

      plansEyebrow: { hu: "// elérhető csomagok", en: "// available plans" },
      plansTitle: { hu: "Csomagok", en: "Plans" },
      currentBadge: { hu: "Jelenlegi", en: "Current" },
      recommendedBadge: { hu: "Ajánlott", en: "Recommended" },
      upgradeBtn: { hu: "Upgrade", en: "Upgrade" },
      activateBtn: { hu: "Aktiválás", en: "Activate" },
      contactSales: { hu: "Kapcsolatfelvétel", en: "Contact sales" },
      perMonth: { hu: "/ hó", en: "/ mo" },
      perYear: { hu: "/ év", en: "/ yr" },
      monthly: { hu: "Havi", en: "Monthly" },
      annual: { hu: "Éves", en: "Annual" },
      annualSave: { hu: "Spórolj éves számlázással", en: "Save with annual billing" },
      teamDesc: { hu: "Max 10 tag, csapatjelentések", en: "Up to 10 members, team reports" },
      orgDesc: { hu: "Max 40 tag, szervezeti elemzések", en: "Up to 40 members, org analytics" },
      scaleDesc: { hu: "Korlátlan tag, egyedi támogatás", en: "Unlimited members, dedicated support" },
      teamSeats: { hu: "10 hely", en: "10 seats" },
      orgSeats: { hu: "40 hely", en: "40 seats" },
      scaleSeats: { hu: "Korlátlan", en: "Unlimited" },

      productsEyebrow: { hu: "// egyszeri termékek", en: "// one-time products" },
      productsTitle: { hu: "Termékek", en: "Products" },
      teamSnapshotName: { hu: "Team Snapshot", en: "Team Snapshot" },
      teamSnapshotDesc: { hu: "Csapatdiagnózis, heatmap és összefoglaló", en: "Team diagnosis, heatmap and summary" },
      teamDeepDiveName: { hu: "Team Deep Dive", en: "Team Deep Dive" },
      teamDeepDiveDesc: { hu: "Mély elemzés + 1 tanácsadói konzultáció", en: "Deep analysis + 1 advisory consultation" },
      candidatePackName: { hu: "Jelölt kreditek", en: "Candidate credits" },
      candidatePackDesc: { hu: "Felvételi jelölt értékelések", en: "Hiring candidate assessments" },
      buyBtn: { hu: "Megvásárlás", en: "Purchase" },
      selectTeam: { hu: "Csapat kiválasztása", en: "Select team" },

      invoicesEyebrow: { hu: "// számlák és bizonylatok", en: "// invoices & receipts" },
      invoicesTitle: { hu: "Számlák és bizonylatok", en: "Invoices & receipts" },
      noInvoices: { hu: "Még nincs számla.", en: "No invoices yet." },
      itemCol: { hu: "Tétel", en: "Item" },
      amountCol: { hu: "Összeg", en: "Amount" },
      dateCol: { hu: "Dátum", en: "Date" },
      downloadCol: { hu: "Letöltés", en: "Download" },
      invoiceBtn: { hu: "Számla", en: "Invoice" },
      receiptBtn: { hu: "Bizonylat", en: "Receipt" },
      downloading: { hu: "...", en: "..." },

      readOnly: { hu: "A számlázás megtekintése csak admin számára szerkeszthető.", en: "Billing management requires admin access." },

      upgradeModalTitle: { hu: "Csomag váltás megerősítése", en: "Confirm plan change" },
      upgradeModalFrom: { hu: "Jelenlegi csomag", en: "Current plan" },
      upgradeModalTo: { hu: "Új csomag", en: "New plan" },
      upgradeModalProration: { hu: "A fennmaradó idő arányosan jóváírásra kerül.", en: "Remaining time will be prorated." },
      upgradeModalConfirm: { hu: "Váltás megerősítése", en: "Confirm change" },
      upgradeModalCancel: { hu: "Mégse", en: "Cancel" },
      upgradeModalProcessing: { hu: "Feldolgozás...", en: "Processing..." },
      upgradeSuccess: { hu: "A csomag sikeresen módosult.", en: "Plan changed successfully." },
      upgradeError: { hu: "A csomag váltás sikertelen. Próbáld újra.", en: "Plan change failed. Please try again." },

      productSelfPlus: { hu: "Self Plus", en: "Self Plus" },
      productTeamSnapshot: { hu: "Team Snapshot", en: "Team Snapshot" },
      productTeamDeepDive: { hu: "Team Deep Dive", en: "Team Deep Dive" },
      productCandidatePack: { hu: "Jelölt kreditek", en: "Candidate credits" },
      productTeamSub: { hu: "Team előfizetés", en: "Team subscription" },
      productOrgSub: { hu: "Org előfizetés", en: "Org subscription" },
    },
  ...
  orgRisk: {
    pendingTitle: { hu: "Függő meghívások", en: "Pending invites" },
    ...
    noActiveDesc: { hu: "A szervezeti trendekhez érdemes aktív visszajelzési kört futtatni.", en: "Run an active feedback round to track org-level trends." },
    ...
    recommendedCampaignDesc: { hu: "A következő szervezeti insight körhöz indíts új kampányt.", en: "Launch a new campaign for the next org insight cycle." },
  ...
  orgLayers: {
    ...
    layersTitle: { hu: "Szervezeti mélyítő rétegek", en: "Org deepening layers" },
  ...
  dashboard: {
    ...
    retry: { hu: "Újrapróbálás", en: "Retry" },
    ...
    reminderFallbackDesc: { hu: "Most a {teamName} csapat hiányzó tagjait kell emlékeztetni, hogy lezárható legyen a csapatkép.", en: "Right now, remind missing members in {teamName} so the team insight can be completed." },
    reminderFallbackPrimary: { hu: "Tagok emlékeztetése", en: "Remind members" },
    snapshotFallbackDesc: { hu: "A csapatkép már elérhető. Következő lépésként nyisd meg és egyeztesd a csapattal.", en: "Team insight is available. Next step: open it and align with the team." },
    snapshotFallbackPrimary: { hu: "Csapatkép megnyitása", en: "Open team insight" },
    campaignFallbackDesc: { hu: "A következő kör már indítható. Következő lépésként indíts új visszajelzési kört.", en: "The next round can be launched now. Next step: start a new feedback round." },
    ...
    unlockTeamPattern: { hu: "Első csapatkép feloldása", en: "Unlock first team pattern" },
    ...
    orgCompletion: { hu: "Szervezeti kitöltés", en: "Org completion" },
    teamPatternReadiness: { hu: "Csapatkép készültség", en: "Team pattern readiness" },
    onboardingEyebrow: { hu: "onboarding", en: "onboarding" },
    firstTeamKickoff: { hu: "Első csapat indulása", en: "First team kickoff" },
    onboardingDesc: { hu: "Az első csapat már létrejött. Ezen a checklisten végigmenve gyorsan eljuttok az első értelmezhető csapatképig.", en: "Your first team is already created. Follow this checklist to quickly unlock the first meaningful team pattern." },
    nextStep: { hu: "Következő lépés", en: "Next step" },
    upcomingModules: { hu: "Következő modulok (hamarosan)", en: "Upcoming modules (soon)" },
    onboardingFocus: { hu: "onboarding fókusz", en: "onboarding focus" },
    onboardingFocusDesc: { hu: "Amíg az induló onboarding lépések nincsenek kész, a többi dashboard modul előnézet módban marad.", en: "Until the starter onboarding steps are done, the remaining dashboard modules stay in preview mode." },
    ...
    layerReadiness: { hu: "4+2 rétegkészültség", en: "4+2 layer readiness" },
    ...
    frictionDesc: { hu: "A szervezet kreatív lendülettel dolgozik, de az alacsony {low} ({pct}%) növelheti a belső zajt csapatközi helyzetekben.", en: "The organization works with strong creative momentum, but lower {low} ({pct}%) may increase friction in cross-team situations." },
  ...
  billing: {
    ...
    returnCandidateBody: {
      hu: "A jelölt kreditek sikeresen hozzáadva. Most már meghívhatod a következő jelölteket.",
    ...
    returnSubCta: { hu: "Vissza a vezérlőpulthoz →", en: "Go to dashboard →" },
    returnExpiredTitle: { hu: "A munkamenet lejárt", en: "Session expired" },
    returnExpiredBody: {
      hu: "Kérjük, próbáld újra az előfizetés aktiválását.",
      en: "Please try activating your subscription again.",
    },
    returnExpiredCta: { hu: "Újrapróbálás", en: "Try again" },
  },
  candidate: {
    ...
    introBody: {
      hu: "Ez a felmérés {count} kérdésből áll, és körülbelül 15–20 percet vesz igénybe. Kérjük, válaszolj őszintén, az első benyomásod alapján.",
      en: "This assessment contains {count} questions and takes approximately 15–20 minutes. Please answer honestly based on your first impression.",
    },
    introAutoSave: {
    ...
    doneBody: {
      hu: "A válaszaid sikeresen beküldtük. A szervező hamarosan értesítést kap az eredményekről.",
    ...
    scaleHint: {
      hu: "Az 1–5 skálán: 1 = Egyáltalán nem értek egyet, 5 = Teljes mértékben egyetértek",
      en: "On the 1–5 scale: 1 = Strongly disagree, 5 = Strongly agree",
    },
    answerAllError: {
      hu: "Kérjük, válaszolj minden kérdésre.",
      en: "Please answer all questions.",
    },
    submitError: {
      hu: "Hiba történt a beküldés során. Kérjük, próbáld újra.",
      en: "An error occurred while submitting. Please try again.",
    },
    pageCompletedTitle: { hu: "Már kitöltötted!", en: "Already completed!" },
    pageCompletedBody: {
      hu: "Ezt a felmérést már korábban sikeresen beküldted. Köszönjük a részvételt!",
  ...
  hiring: {
    ...
    creditEyebrow: { hu: "jelölt kreditek", en: "candidate credits" },
    ...
    creditLogEyebrow: { hu: "kredit napló", en: "credit log" },
    creditPurchase: { hu: "Kredit vásárlás", en: "Credit purchase" },
    creditUsage: { hu: "Kredit felhasználás", en: "Credit usage" },
    ...
    featureEmailTitle: { hu: "E-mail meghívó", en: "Email invitation" },
    featureEmailDesc: {
    ...
    featureRoleFitTitle: { hu: "Szerep-illeszkedés", en: "Role fit" },
    featureRoleFitDesc: {
    ...
    addonPricing: {
      hu: "Kreditenként €39 · 5+ vásárlás esetén −15% · 10+ vásárlás esetén −20%",
      en: "€39 per credit · −15% for 5+ · −20% for 10+",
    },
    noSubPricing: {
    ...
    noAssessments: {
      hu: "A(z) {name} csapatnak nincs befejezett értékelése.",
  ...
  teamComp: {
    ...
    roleFitScore: { hu: "Illeszkedési pont", en: "Fit score" },
    roleFitConfidence: { hu: "Biztonság", en: "Confidence" },
  ...
  team: {
    ...
    createNewDesc: {
      hu: "Adj nevet a csapatnak, majd add hozzá a tagokat emailcím alapján.",
  ...
  join: {
    ...
    consentText: {
      hu: "Hozzájárulok adataim kezeléséhez a",
    ...
    welcomePrefix: { hu: "Üdv", en: "Welcome" },
    submitNew: {
    ...
    switchDescription: {
      hu: "Jelenleg a {existingOrg} az aktív szervezeti kontextusod. Ha csatlakozol a {orgName} szervezethez, a korábbi tagságod megmarad, csak az aktív kontextus vált át.",
    ...
    switchPrimary: {
      hu: "Átváltás a(z) {orgName} szervezetbe →",
    ...
    readySameOrg: {
      hu: "Csatlakozol a {teamName} csapathoz a meglévő szervezeti tagságoddal.",
      en: "You are joining {teamName} with your existing organization membership.",
    },
    readyNewOrg: {
      hu: "Csatlakozol a {orgName} szervezethez és a {teamName} csapathoz. A meglévő eredményeid megmaradnak.",
    ...
    readyText: {
      hu: "Készen állsz csatlakozni a {orgName} szervezethez. A meglévő személyes eredményeid megmaradnak.",
  ...
  teamDetail: {
    ...
    secondaryPatternReadiness: { hu: "Csapatkép készültség", en: "Pattern readiness" },
    ...
    // Recommended action
    nextStep: { hu: "Következő lépés", en: "Next step" },
    actionObserverActive: { hu: "A visszajelzési kör fut, kövesd és zárd le a hiányzó visszajelzéseket.", en: "The feedback round is active. Track and close remaining feedback." },
    ...
    sectionJourney: { hu: "Journey checklist", en: "Journey checklist" },
    journeyProgress: { hu: "haladás", en: "progress" },
    journeyTitle: { hu: "Csapatút követése", en: "Track team journey" },
    journeyDescription: { hu: "Ugyanarra a journey logikára építve látod, hol tart a csapat és mi hiányzik a következő szinthez.", en: "Built on the same journey logic, this shows where the team stands and what is missing for the next level." },
    ...
    checkAssessments: { hu: "Kitöltések lezárása", en: "Assessments completed" },
    ...
    checkFeedbackActive: { hu: "Aktív kör fut a csapaton.", en: "An active round is running." },
    checkFeedbackNone: { hu: "Még nincs aktív observer kör.", en: "No active observer round yet." },
    checkFeedbackCta: { hu: "Kör indítása", en: "Start round" },

    // 4+2 layer section
    sectionLayers: { hu: "4+2 rétegkészültség", en: "4+2 layer readiness" },
  ...
  orgOnboarding: {
    // Heading
    welcomeTitle: { hu: "Üdvözlünk a tritán.", en: "Welcome to trita." },
    ...
    // Layer roadmap
    layerRoadmap: { hu: "Layer útiterv", en: "Layer roadmap" },
    statusCompleted: { hu: "Kész", en: "Completed" },
    statusInProgress: { hu: "Folyamatban", en: "In progress" },
    statusAvailable: { hu: "Elérhető", en: "Available" },
    statusLocked: { hu: "Zárolt", en: "Locked" },
    layerPlusNote: { hu: "A +2 réteg opcionális mélyítésként jelenik meg, amikor az alap self és team rétegek készen állnak.", en: "The +2 layers appear as optional deepening once the core self and team layers are ready." },

    // Step 1
    step01: { hu: "Lépés 01", en: "Step 01" },
    ...
    valPleaseChoose: { hu: "Kérjük válassz", en: "Please choose one" },
    ...
    valConsentError: { hu: "Hiba történt, kérjük próbáld újra.", en: "Something went wrong. Please try again." },

    // Step 2
    step02: { hu: "Lépés 02", en: "Step 02" },
    ...
    // Step 3
    step03: { hu: "Lépés 03", en: "Step 03" },
    step03Title: { hu: "Az első csapatod", en: "Your first team" },
    step03Subtitle: { hu: "Adj nevet a csapatnak, majd oszd meg a meghívó linket a tagokkal.", en: "Name your team, then share the invite link with members." },
    teamName: { hu: "Csapat neve", en: "Team name" },
    ...
    // Invite link
    inviteLinkLabel: { hu: "Meghívó link", en: "Invite link" },
    ...
    goToDashboard: { hu: "Megyek a dashboardra →", en: "Go to dashboard →" },

    // Step 4
    step04: { hu: "Lépés 04", en: "Step 04" },
    ...
    // Footer
    footerNote: { hu: "Bármikor módosíthatod ezeket a beállításokat a profil oldalon.", en: "You can update these settings anytime on your profile page." },
