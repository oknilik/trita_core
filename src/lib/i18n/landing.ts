export const landingTranslations = {
  landing: {
    ...
    selfTeamRolePrimary: { hu: "Elsődleges", en: "Primary" },
    selfTeamRoleSecondary: { hu: "Másodlagos", en: "Secondary" },
    selfTeamRoleTertiary: { hu: "Harmadik", en: "Tertiary" },
    selfTeamRole1Name: { hu: "Formáló", en: "Shaper" },
    selfTeamRole1Desc: { hu: "Dinamikus hajtóerő", en: "Dynamic driving force" },
    selfTeamRole2Name: { hu: "Kapcsolatépítő", en: "Networker" },
    selfTeamRole2Desc: { hu: "Hálózatépítés", en: "Networking" },
    selfTeamRole3Name: { hu: "Ötletgazda", en: "Plant" },
    selfTeamRole3Desc: { hu: "Kreatív megoldások", en: "Creative solutions" },
