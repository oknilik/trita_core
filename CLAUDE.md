...
| **Közös vállalások** | `src/lib/team-commitments.server.ts`, `components/team/TeamCommitments.tsx`, `/team/[id]?tab=commitments` | Riporttól független élő vállalások, névhez kapcsolt felelős, személyes frissítés, verzióellenőrzött mentés és eseménynapló. Publikált javaslat csak explicit importtal kerül át; régi owner-szöveg nem ad jogot. Doksi: `docs/product/team-commitments.md`. |
