...
- [~] P5.7 interakció-szimuláció — tervezési doksi kész: `docs/product/riport-interakcio-szimulacio-terv.md` (dimenzió-pár relációs motor ~30 atommal, web-first, 5 fázis). **Döntések 2026-07-24:** teljesen ingyenes; vezető-mód a v1-ben; PDF-ízelítő igen (a webes v1 után). Implementáció beütemezve: F1 atomok júl 27–31 → F2 motor aug 3–4 → F3 web UI aug 5–7 → PDF-ízelítő aug 10 → F4 team view aug 11–13; F5 guest-változat szeptember végén. Részletek a terv-doksi 5–6. pontjában.
