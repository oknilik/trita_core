...
If you are planning the introduction, read our [article on introducing an assessment](/blog/introducing-psychometric-assessment) first. The voluntariness of a measurement directly affects how credible the results are. Psychological safety is one layer of trita's team picture, alongside team roles and the trust network. Our [team diagnostics page](/team-dynamics) describes how the three layers are read together.
