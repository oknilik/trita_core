...
import { derivePublicLadder, ladderBaseFee } from "@/lib/pricing/team-ladder";
...
describe("csapat-oldal (egyesített)", () => {
  ...
  it("az ár-horgony a díjkártya belépő árát mutatja, kalkulátor nélkül", () => {
    ...
    expect(within(anchor).getByText(plain(hufAmount(ladderBaseFee(ladder, "kep"))))).toBeInTheDocument();
